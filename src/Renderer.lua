...
function Renderer:init()
  ...
  self.DRAW_ORDERING = {"Worker Bullet", "Sinistar Construction", "workerExplosion", "warriorExplosion", "Player Bullet", "Asteroid", "AsteroidFrag", "Crystal", "Sinistar", "Warrior Bullet", "Sinibomb", "Worker", "Player Thrust", "Player", "Warrior", "Sinibomb Blast"}
end
